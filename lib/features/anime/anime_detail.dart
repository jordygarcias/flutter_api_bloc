...
class AnimeDetail extends StatelessWidget {
  ...
  Future<List<AnimeCharacterEntity>> _getAnimeCharactersList(animeId) async {
    ...
    if (response.statusCode == 200) {
      final charactersMap = response.data['data'].map((item) => AnimeCharacterEntity.fromJson(item['character']));
          ...
          children: [
            ...
            FutureBuilder<List<AnimeCharacterEntity>>(
              ...
              builder: (context, snapshot) {
                ...
                final List<AnimeCharacterEntity> characters = snapshot.data!;
                ...
                return GridView.count(
                  ...
                  mainAxisSpacing: 10,
                  crossAxisSpacing: 10,
                  children: characters.map((character) => CharacterItem(
                    character: character
                  )).toList(),
                );
              }
